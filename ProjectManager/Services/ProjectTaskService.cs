...
namespace ProjectManager.Services
{
    public class ProjectTaskService : IProjectTaskService
    {
        ...
        public async Task<ProjectTaskDto> Update(UpdateProjectTaskDto updateProjectTaskDto)
        {
            ...
            var updateProjectTask = await _projectTaskRepository.Update(projectTask);
            return _mapper.Map<ProjectTaskDto>(updateProjectTask);
        }
        public Task Delate(int id)
        {
            return _projectTaskRepository.Delate(id);
        }
    }
}
